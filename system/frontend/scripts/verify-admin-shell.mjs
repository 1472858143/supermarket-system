...
const checks = [
  ...
  ['AdminLayout applies explicit sidebar active class', layout.includes("'is-active': item.path === activeSidebarPath")],
  ['AdminLayout maps inventory child routes to inventory center', layout.includes("'/stockchecks': '/inventory-center'") && layout.includes("'/stocks': '/inventory-center'")],
  ['styles define explicit sidebar active state', styles.includes('.nav a.is-active')],
