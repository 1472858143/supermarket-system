...
public class PurchaseInboundReceiptVO {
    ...
    private List<PurchaseInboundReceiptBatchVO> batches;
    ...
    public List<PurchaseInboundReceiptBatchVO> getBatches() {
        return batches;
    }

    public void setBatches(List<PurchaseInboundReceiptBatchVO> batches) {
